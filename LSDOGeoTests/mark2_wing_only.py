...
geometry = lsdo_geo.import_geometry(
    "c:/Users/seth3/David_VTOL_LSDO/LSDOGeoTests/mark2_wing_only.stp",
...
# leading_edge_left = geometry.project(np.array([0.25, -2.0, 0.25]))
# leading_edge_right = geometry.project(np.array([0.25, 2.0, 0.25]))
# trailing_edge_left = geometry.project(np.array([1.0, -2.0, 0.25]))
# trailing_edge_right = geometry.project(np.array([1.0, 2.0, 0.25]))
# leading_edge_center = geometry.project(np.array([0.25, 0.0, 0.25]))
# trailing_edge_center = geometry.project(np.array([1.0, 0.0, 0.25]))
# quarter_chord_left = geometry.project(np.array([0.52, -2.0, 0.25]))
# quarter_chord_right = geometry.project(np.array([0.52, 2.0, 0.25]))
# quarter_chord_center = geometry.project(np.array([0.52, 0.0, 0.25]))
leading_edge_left = geometry.project(np.array([x_LE, -span/2, z_LE]))
leading_edge_right = geometry.project(np.array([x_LE, span/2, z_LE]))
trailing_edge_left = geometry.project(np.array([x_TE, -span/2, z_LE]))
trailing_edge_right = geometry.project(np.array([x_TE, span/2, z_LE]))
leading_edge_center = geometry.project(np.array([x_LE, 0.0, z_LE]))
trailing_edge_center = geometry.project(np.array([x_TE, 0.0, z_LE]))
quarter_chord_left = geometry.project(np.array([x_qc, -span/2, z_LE]))
quarter_chord_right = geometry.project(np.array([x_qc, span/2, z_LE]))
quarter_chord_center = geometry.project(np.array([x_qc, 0.0, z_LE]))
# endregion
...
num_spanwise = 11
num_chordwise = 4
points_to_project_on_leading_edge = np.linspace(np.array([0.25, -2., 1.]), np.array([0.25, 2., 1.]), num_spanwise)
points_to_project_on_trailing_edge = np.linspace(np.array([1., -2., 1.]), np.array([1., 2., 1.]), num_spanwise)
...
wingspan_outer_dv = csdl.Variable(shape=(1,), value=np.array([4.0]))
